...
public class Dev {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((conteudosIncristos == null) ? 0 : conteudosIncristos.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (nome == null) {
            ...
            return false;
        if (conteudosIncristos == null) {
            if (other.conteudosIncristos != null)
                return false;
        } else if (!conteudosIncristos.equals(other.conteudosIncristos))
            return false;
